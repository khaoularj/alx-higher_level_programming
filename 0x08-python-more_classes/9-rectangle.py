...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        msg_1_T_error = "rect_1 must be an instance of Rectangle"
        msg_2_T_error = "rect_2 must be an instance of Rectangle"
        if not isinstance(rect_1, Rectangle):
            raise TypeError(msg_1_T_error)
        if not isinstance(rect_2, Rectangle):
            raise TypeError(msg_2_T_error)
